...
let resultList = {results:[{Hand: "78s",Result: "Win"},{Hand: "AA",Result: "Loss"},{Hand: "AQo",Result: "Loss"}]}
...
app.post("/addResult", (req, res) =>{
    ...
    resultList.results.push({Hand: `${hand}`, Result: `${result}`})
})
